Camera2Basic app to extract RAW images
====================================

This code is a modified version of the Camera2Basic Sample in Kotlin,
that takes a RAW image instead of a JPEG Image.

Given below is the documentation of the Camera2Basic app.
...
For capturing RAW images, you have to use ImageFormat.RAW_SENSOR as the 
format when creating a new instance of ImageReader
...
- Figure out a way to be able to take different types of images using the same app
- RAW image preprocessing, see if a better format is available
- OpenCV integration (?)
